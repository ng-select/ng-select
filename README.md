...
| [collapseGroupByDefault]    | `boolean`                                            | `false`             | no | If set to `true` it will collapse the groups be default. It will have no effect unless `collapsibleGroup` is set to `true`                                                                     |

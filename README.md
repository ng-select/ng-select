...
| [collapsibleGroup]          | `boolean`                                            | `false`             | no | Indicates whether to have collapsible controls for the groups                                                                                                                                  |
| [collapseGroupByDefault]    | `boolean`                                            | `false`             | no | If set to `true` it will collapse the groups by default. It will have no effect unless `collapsibleGroup` is set to `true`                                                                     |

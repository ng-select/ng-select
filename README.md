...
| [keyDownFn] | `(keyCode: number, $event: KeyboardEvent) => false | unknown` |  `null` | no | Provide custom keyDown function. Executed before default handler. Return false to suppress execution of default key down handlers  |

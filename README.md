...
| [tabFocusOnClearButton]     | `boolean`                                            | `true`              | no | Control tab navigation behavior for the clear button. Default `false`. Can override **tabFocusOnClear** (from NgSelectConfig) when set to `true`.

...
description: 'Ng-select filters items as you type and supports custom search functions, server-side typeahead, and autocomplete scenarios.'
sidebar:
  order: 4
---
...
<Demo example="search-default-example" />

## Search across multiple fields using [searchFn]

<Demo example="search-custom-example" />

## Custom server-side search

<Demo example="search-autocomplete-example" />

## Editable search value

<Demo example="search-editable-example" />

...
description: 'ng-select can render large lists efficiently by enabling `[virtualScroll]="true"`, which only renders the options currently visible in the dropdown viewport.'
sidebar:
  order: 10
---
...
<Demo example="virtual-scroll-example" />

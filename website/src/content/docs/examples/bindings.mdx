---
title: Data bindings
description: 'ng-select can bind to plain values, whole objects, or nested properties using `bindLabel` and `bindValue`.'
sidebar:
  order: 2
---
...
<Demo example="bindings-default-example" />

## Bind to custom values

<Demo example="bindings-custom-example" />

## Bind to nested properties

<Demo example="bindings-nested-example" />

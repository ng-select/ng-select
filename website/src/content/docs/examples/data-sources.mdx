---
title: Data sources
description: 'ng-select accepts items from an array of objects, inline `ng-option` elements, or asynchronous/observable data.'
sidebar:
  order: 1
---
...
<Demo example="data-source-array-example" />

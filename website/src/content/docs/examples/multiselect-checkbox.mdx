...
description: 'Render checkboxes inside dropdown options by using custom option templates in multiselect mode.'
sidebar:
  order: 8
---
...
<Demo example="multi-checkbox-example" />

## Grouped multi select with checkboxes

<Demo example="multi-checkbox-group-example" />

...
description: 'Control where the dropdown panel opens relative to the select — top, bottom, or auto based on available space.'
sidebar:
  order: 11
---
...
<Demo example="dropdown-position-example" />

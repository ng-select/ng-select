---
title: Grouping
description: 'Use the `groupBy` input to group options by an item key or a function expression.'
sidebar:
  order: 15
---
...
<Demo example="group-default-example" />

## Group by function expression

<Demo example="group-function-example" />

## Selectable groups

<Demo example="group-selectable-example" />

## Selectable groups with hidden selected items

<Demo example="group-selectable-hidden-example" />

## Items with already grouped children array

<Demo example="group-children-example" />

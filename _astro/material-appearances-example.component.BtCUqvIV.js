import{$t as e,Qt as t,Y as n,Zt as r,_t as i,at as a,it as o,jt as s,qt as c,rt as l,vt as u}from"./common.25e7-6ky.js";import{O as d,_ as f,m as p,t as m,u as h}from"./public-api.waqTmbx1.js";var g=class g{constructor(){this.cities=[{id:1,name:`Vilnius`},{id:2,name:`Kaunas`},{id:3,name:`Pavilnys`},{id:4,name:`Pabradė`},{id:5,name:`Klaipėda`}],this.selectedDefault=this.cities[0],this.selectedOutline=this.cities[0],this.selectedFill=this.cities[0],this.selectedOutlineEmpty=null}static{this.ɵfac=function(e){return new(e||g)}}static{this.ɵcmp=a({type:g,selectors:[[`ng-material-appearances-example`]],decls:33,vars:8,consts:[[1,`form-row`],[1,`form-group`,`col-md-4`],[`for`,`material-default`],[`id`,`material-default`,`bindLabel`,`name`,`placeholder`,`Select city`,3,`ngModelChange`,`items`,`ngModel`],[`for`,`material-outline`],[`id`,`material-outline`,`appearance`,`outline`,`bindLabel`,`name`,`placeholder`,`Select city`,3,`ngModelChange`,`items`,`ngModel`],[`for`,`material-fill`],[`id`,`material-fill`,`appearance`,`fill`,`bindLabel`,`name`,`placeholder`,`Select city`,3,`ngModelChange`,`items`,`ngModel`],[`for`,`material-outline-empty`],[`id`,`material-outline-empty`,`appearance`,`outline`,`bindLabel`,`name`,`placeholder`,`Select city`,3,`ngModelChange`,`items`,`ngModel`],[`for`,`material-outline-options`],[`id`,`material-outline-options`,`appearance`,`outline`,`placeholder`,`foo`]],template:function(a,d){a&1&&(u(0,`p`),c(1,` Compare Material theme appearances. Switch the demo theme to `),u(2,`strong`),c(3,`Material`),i(),c(4,` in the header to see underline, outline, and fill styles. Focus a searchable control and type to check that the search input stays vertically aligned with the selected value.
`),i(),u(5,`div`,0)(6,`div`,1)(7,`label`,2),c(8,`Default (underline)`),i(),u(9,`ng-select`,3),o(),t(`ngModelChange`,function(e){return r(d.selectedDefault,e)||(d.selectedDefault=e),e}),i()(),u(10,`div`,1)(11,`label`,4),c(12,`Outline`),i(),u(13,`ng-select`,5),o(),t(`ngModelChange`,function(e){return r(d.selectedOutline,e)||(d.selectedOutline=e),e}),i()(),u(14,`div`,1)(15,`label`,6),c(16,`Fill`),i(),u(17,`ng-select`,7),o(),t(`ngModelChange`,function(e){return r(d.selectedFill,e)||(d.selectedFill=e),e}),i()()(),u(18,`div`,0)(19,`div`,1)(20,`label`,8),c(21,`Outline (empty / floating label)`),i(),u(22,`ng-select`,9),o(),t(`ngModelChange`,function(e){return r(d.selectedOutlineEmpty,e)||(d.selectedOutlineEmpty=e),e}),i()(),u(23,`div`,1)(24,`label`,10),c(25,`Outline with ng-option`),i(),u(26,`ng-select`,11)(27,`ng-option`),c(28,`AAA`),i(),u(29,`ng-option`),c(30,`BBB`),i(),u(31,`ng-option`),c(32,`CCC`),i()()()()),a&2&&(n(9),s(`items`,d.cities),e(`ngModel`,d.selectedDefault),l(),n(4),s(`items`,d.cities),e(`ngModel`,d.selectedOutline),l(),n(4),s(`items`,d.cities),e(`ngModel`,d.selectedFill),l(),n(5),s(`items`,d.cities),e(`ngModel`,d.selectedOutlineEmpty),l())},dependencies:[h,p,f,m,d],styles:[`[_nghost-%COMP%]     :root {
...
[_nghost-%COMP%]     .ng-dropdown-panel .ng-dropdown-panel-items .ng-option .ng-tag-label {
  ...
  font-weight: 400;
  color: var(--%NS%ng-select-disabled-text, rgba(0, 0, 0, 0.38));
}`],changeDetection:1})}};export{g as MaterialAppearancesExampleComponent};
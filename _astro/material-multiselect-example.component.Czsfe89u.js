import{$t as e,Qt as t,Y as n,Zt as r,_t as i,at as a,it as o,jt as s,qt as c,rt as l,vt as u}from"./common.25e7-6ky.js";import{_ as d,m as f,t as p,u as m}from"./public-api.waqTmbx1.js";var h=class h{constructor(){this.cities=[{id:1,name:`Vilnius`},{id:2,name:`Kaunas`},{id:3,name:`Pavilnys`},{id:4,name:`Pabradė`},{id:5,name:`Klaipėda`}],this.selectedOutline=[this.cities[0],this.cities[1]],this.selectedFill=[this.cities[0]]}static{this.ɵfac=function(e){return new(e||h)}}static{this.ɵcmp=a({type:h,selectors:[[`ng-material-multiselect-example`]],decls:11,vars:8,consts:[[1,`form-row`],[1,`form-group`,`col-md-6`],[`for`,`material-multi-outline`],[`id`,`material-multi-outline`,`appearance`,`outline`,`bindLabel`,`name`,`placeholder`,`Select cities`,3,`ngModelChange`,`items`,`multiple`,`closeOnSelect`,`ngModel`],[`for`,`material-multi-fill`],[`id`,`material-multi-fill`,`appearance`,`fill`,`bindLabel`,`name`,`placeholder`,`Select cities`,3,`ngModelChange`,`items`,`multiple`,`closeOnSelect`,`ngModel`]],template:function(a,d){a&1&&(u(0,`p`),c(1,`Multiple selection with Material outline and fill appearances.`),i(),u(2,`div`,0)(3,`div`,1)(4,`label`,2),c(5,`Outline multiselect`),i(),u(6,`ng-select`,3),o(),t(`ngModelChange`,function(e){return r(d.selectedOutline,e)||(d.selectedOutline=e),e}),i()(),u(7,`div`,1)(8,`label`,4),c(9,`Fill multiselect`),i(),u(10,`ng-select`,5),o(),t(`ngModelChange`,function(e){return r(d.selectedFill,e)||(d.selectedFill=e),e}),i()()()),a&2&&(n(6),s(`items`,d.cities)(`multiple`,!0)(`closeOnSelect`,!1),e(`ngModel`,d.selectedOutline),l(),n(4),s(`items`,d.cities)(`multiple`,!0)(`closeOnSelect`,!1),e(`ngModel`,d.selectedFill),l())},dependencies:[m,f,d,p],styles:[`[_nghost-%COMP%]     :root {
...
[_nghost-%COMP%]     .ng-dropdown-panel .ng-dropdown-panel-items .ng-option .ng-tag-label {
  ...
  font-weight: 400;
  color: var(--%NS%ng-select-disabled-text, rgba(0, 0, 0, 0.38));
}`],changeDetection:1})}};export{h as MaterialMultiselectExampleComponent};
...
export class NgSelectComponent implements OnDestroy, OnChanges, AfterViewInit, ControlValueAccessor {
    ...
    // custom template
    @ContentChild(NgPlaceholderTemplateDirective, { read: TemplateRef, static: true }) placeholderTemplate: TemplateRef<any>;
    ...
    @ViewChild(forwardRef(() => NgDropdownPanelComponent), { static: true }) dropdownPanel: NgDropdownPanelComponent;

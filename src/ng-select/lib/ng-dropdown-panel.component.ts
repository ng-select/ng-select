...
export class NgDropdownPanelComponent implements OnInit, OnChanges, OnDestroy {
	...
	readonly outsideClickType = input<'click' | 'mousedown'>('click');
	...
	private _handleOutsideClick() {
		...
		this._zone.runOutsideAngular(() => {
			const clickEventType = this.outsideClickType();
			merge(fromEvent(this._document, 'touchstart', { capture: true }), fromEvent(this._document, clickEventType, { capture: true }))

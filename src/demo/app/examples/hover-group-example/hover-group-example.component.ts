...
@Component({
    selector: 'hover-group-example',
    templateUrl: './hover-group-example.component.html',
    styleUrls: ['./hover-group-example.component.scss']
})
export class HoverGroupExampleComponent implements OnInit {
    ...
    accounts = [
        ...
        { name: 'Paul', email: 'paul@email.com', age: 26, country: 'Unknown', disabled: true, child: { state: 'Active' } },
        { name: 'Georgia', email: 'georgia@email.com', age: 31, country: 'Unknown', disabled: true, child: { state: 'Active' } },
